...
export function createCombatDefinitionReader(registry: DefinitionRegistry): CombatDefinitionReader {
  ...
  return {
    getCombatRule: (id) => combatRule.get(id),
    getEncounterGroup: (id) => encounterGroup.get(id),
    getMonster: (id) => monster.get(id),
    getSkillView: (id) => skill.get(id),
    trySkillView: (id) => skill.tryGet(id),
    getOpeningCtbRule: (id) => openingCtb.get(id),
    getActionDelayRule: (id) => actionDelay.get(id),
    getCombatStatus: (id) => status.get(id),
    getCombatEffect: (id) => effect.get(id),
    getDamageRule: (id) => damage.get(id),
    ...
    getMonsterExperienceProfile: (id) => monsterExperience.get(id),
  };
}
