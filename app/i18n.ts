...
export const UI_TEXT = {
  ...
  'ui.combat.enemyNumber': {'zh-Hant':'敵 {n}',en:'E {n}'},
  'ui.combat.currentTurn': {'zh-Hant':'目前行動',en:'Current'},
  'ui.combat.readyTurn': {'zh-Hant':'已就緒',en:'Ready'},
  'ui.combat.unableTurn': {'zh-Hant':'無法行動',en:'Unable to act'},
  'ui.combat.turnOrder': {'zh-Hant':'行動順序',en:'Turn order'},
  'ui.combat.loading': {'zh-Hant':'戰場準備中…',en:'Preparing battlefield…'},
  'ui.combat.playing': {'zh-Hant':'交戰中…',en:'Resolving turn…'},
  'ui.combat.victoryTitle': {'zh-Hant':'戰鬥勝利',en:'Victory'},
  'ui.combat.defeat': {'zh-Hant':'隊伍戰敗',en:'Defeat'},
  'ui.combat.resultSaved': {'zh-Hant':'戰鬥已結束。',en:'The battle has ended.'},
  'ui.combat.continue': {'zh-Hant':'繼續旅程',en:'Continue'},
  'ui.combat.cancelTarget': {'zh-Hant':'取消選取',en:'Cancel targeting'},
  'ui.combat.activeSet': {'zh-Hant':'目前使用',en:'Equipped'},
  'ui.combat.emptyWeapon': {'zh-Hant':'未裝備',en:'Unequipped'},
  'ui.combat.emptySkill': {'zh-Hant':'未配置',en:'Empty slot'},
  'ui.combat.switchOnUse': {'zh-Hant':'使用時切換此組',en:'Switch set on use'},
  'ui.combat.defend': {'zh-Hant':'防禦',en:'Defend'},
  'ui.combat.restShort': {'zh-Hant':'休息',en:'Rest'},
  'ui.combat.useItems': {'zh-Hant':'使用道具',en:'Items'},
  'ui.combat.itemsUnavailable': {'zh-Hant':'戰鬥道具尚未開放',en:'Battle items unavailable'},
  'ui.combat.noGuardSkill': {'zh-Hant':'未配置防禦招式',en:'No guard skill equipped'},
  'ui.combat.showGuardSkills': {'zh-Hant':'查看防禦招式',en:'Show guard skills'},
  'ui.combat.showAllSkills': {'zh-Hant':'顯示全部招式',en:'Show all skills'},
  'ui.combat.resourceUnavailable': {'zh-Hant':'HP／MP 不足',en:'Insufficient HP / MP'},
  'ui.combat.weaponUnavailable': {'zh-Hant':'缺少可用武器',en:'Weapon unavailable'},
  'ui.combat.targetUnavailable': {'zh-Hant':'沒有合法目標',en:'No legal targets'},
  'ui.combat.commands': {'zh-Hant':'開啟行動選單',en:'Open actions'},
  'ui.combat.closeCommands': {'zh-Hant':'關閉行動選單',en:'Close actions'},
  'ui.dungeon.encounter': {'zh-Hant':'怪物遭遇',en:'Encounter'},
  'ui.dungeon.aerial': {'zh-Hant':'地形俯瞰',en:'Terrain overview'},
  'ui.dungeon.ourPosition': {'zh-Hant':'我方位置',en:'Our position'},
  'ui.dungeon.doorOpened': {'zh-Hant':'已開的門',en:'Open door'},
  'ui.dungeon.doorClosed': {'zh-Hant':'未開的門',en:'Closed door'},
  'ui.dungeon.interact': {'zh-Hant':'互動',en:'Interact'},
  'ui.dungeon.approach': {'zh-Hant':'走近互動',en:'Move closer'},
  'ui.dungeon.stairsUp': {'zh-Hant':'上樓',en:'Go upstairs'},
  'ui.dungeon.stairsDown': {'zh-Hant':'下樓',en:'Go downstairs'},
  'ui.dungeon.interactRejected': {'zh-Hant':'目前無法進行這項互動。',en:'This interaction is not available right now.'},
  'ui.dungeon.walkHint': { 'zh-Hant': 'WASD／方向鍵行走 · 走近門或樓梯，按 E 或點選提示互動', en: 'WASD / arrows to walk · approach doors or stairs, then press E or click their marker' },
  'ui.dungeon.party': { 'zh-Hant': '隊伍 {n} 人', en: 'Party: {n}' },
  'ui.quest.handIn': { 'zh-Hant': '交付貨物', en: 'Hand in cargo' },
  'ui.quest.handedIn': { 'zh-Hant': '貨物已交付，請回原公會領取報酬。', en: 'Cargo delivered. Claim your reward at the posting guild.' },
  'ui.quest.buyCargo': { 'zh-Hant': '請至商店購買指定貨物', en: 'Buy the reserved goods at the shop' },
  'ui.quest.deliverCargo': { 'zh-Hant': '貨物已領取，請送至目的地公會', en: 'Cargo collected. Deliver it to the destination guild.' },
  'ui.quest.postingGuild': { 'zh-Hant': '領獎公會：', en: 'Reward guild:' },
  'ui.dungeon.encountersRemaining': { 'zh-Hant': '地牢尚有 {n} 處怪物遭遇', en: '{n} encounters remain in this dungeon' },
  'ui.dungeon.captive': { 'zh-Hant': '被擄的居民', en: 'Captive resident' },
  'ui.dungeon.guardsRemaining': { 'zh-Hant': '尚有 {n} 組守衛；清除後即可救援', en: '{n} guard groups remain; defeat them to rescue the captive' },
  ...
  'ui.play.name': { 'zh-Hant': '姓名', en: 'Name' },
  'ui.play.nameHint': { 'zh-Hant': '留空則依文化取名', en: 'Leave blank for a cultural name' },
  ...
  'ui.save.clear': { 'zh-Hant': '清除存檔與備份', en: 'Delete save and backup' },
  'ui.dungeon.scene': { 'zh-Hant': '地牢立體場景', en: '3D dungeon scene' },
  'ui.dungeon.loading': { 'zh-Hant': '正在載入地牢…', en: 'Loading dungeon…' },
  'ui.dungeon.modelError': { 'zh-Hant': '地牢場景無法載入，請重試。', en: 'Dungeon scene could not be loaded. Please retry.' },
  'ui.dungeon.retry': { 'zh-Hant': '重試', en: 'Retry' },
  'ui.dungeon.cameraHint': { 'zh-Hant': '按住滑鼠拖曳視野 · 點選相鄰房間前進', en: 'Drag to pan · Select an adjacent room to move' },
  'ui.save.confirmClear': { 'zh-Hant': '永久清除這個遊戲的本機存檔與備份？', en: 'Permanently delete this game’s local save and backup?' },
  ...
  'ui.dungeon.roomEmpty': { 'zh-Hant': '這個房間目前沒有怪物，請沿通道深入探索。', en: 'This room is clear. Follow the passages to explore further.' },
