...
[models.json](models.json) 將正式雲華二十種怪物 ID 與隊伍代表對應到八種程序造型、配色及比例。[CombatModels.ts](../../CombatModels.ts) 只建立美術，不決定敵人種類、數量、能力或獎勵。隊伍目前共用旅人造型；不同怪物可共用骨架，尚非逐角色精修、裝備外觀或逐招動作。
