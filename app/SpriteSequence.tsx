...
export function SpriteSequence({image, clip, frame, thumbnail = false}: {
  image: HTMLCanvasElement; clip: SpriteClip; frame: number; thumbnail?: boolean;
}) {
